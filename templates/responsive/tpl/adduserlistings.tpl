        ...
        <div id="main">
			<div class="list-your-property-form">
			    ...
			    <div class="content">
					...
					<form method="post" action="<?php echo URL; ?>/adduserlistings.php" enctype="multipart/form-data">
					<input type="hidden" name="image_session" value="<?php echo $_SESSION['image_session']; ?>">
					    <div class="row">
					    	<div class="span12">

								<h3><span>{@listing_step1}</span></h3>
