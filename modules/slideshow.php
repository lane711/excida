...
if ( !is_numeric( $conf['slideshow_visibility'] ) || $conf['slideshow_visibility'] <= 0 )
{
...
if ($db->numrows($r) > $conf['slideshow_visibility'])
{
	...
	<div class="controls">
	    <center>
	    <a href="javascript:" class="carousel-control ico-prev" rel="prev">&lsaquo;&lsaquo; ' . $lang['Previous'] . '</a> |
	    <a href="javascript:" class="carousel-control ico-next" rel="next">' . $lang['Next'] . ' &rsaquo;&rsaquo;</a>
	    </center>
	</div>';
	*/
}
...
{
	$tpl = PATH . '/templates/' . $cookie_template . '/tpl/property_search_short_slideshow.tpl';
	$template = new Template;
	$template->load( $tpl );
    ...
    {
    	$images = get_images( 'gallery', $f['listing_id'], 340, 200, 1, 1 );
    }
    else
    {
    	$images = get_images( 'hidden', $f['listing_id'], 340, 200, 1, 1 );
    }
...
$tpl = PATH . '/templates/' . $cookie_template . '/tpl/property_search_short_slideshow_footer.tpl';
$template = new Template;
$template->load( $tpl );
$template->publish();
