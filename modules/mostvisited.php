...
echo '<div id="tab-mostvisited" class="tabcontent">';
...
// Fetch all the listings which are approved and sort 
// them by the number of visitors in the descending
// order.
$sql = 'SELECT ' . $title . ', ' . $description . ', ' . PROPERTIES_TABLE . '.* FROM ' . PROPERTIES_TABLE  . ' WHERE approved = 1 ORDER BY hits DESC LIMIT ' . $conf['most_visited_limit'];
